...
function RoadMapCard({ mapData }) {
  return (
    <li className="text-sm leading-6">
      <road className="relative flex flex-col p-4   bg-slate-50 rounded-lg  dark:bg-slate-800 dark:highlight-white/5">
        ...
        <right className="mt-2 pl-3 pr-1">
          <p className="text-start text-sm mt-2 text-slate-400 line-clamp-6">
            {mapData.description}
          </p>
        </right>
      </road>
